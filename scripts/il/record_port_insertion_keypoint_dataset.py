...
parser.add_argument("--disable_contact_sensor", action="store_true", default=False, help="Run without ContactSensor force labels.")
parser.add_argument(
    "--contact_body_regex",
    type=str,
...
parser.add_argument("--enable_fabric", action="store_true", default=False, help="Use Fabric. Default is off because labels read USD frames.")
parser.add_argument("--disable_fabric", action="store_true", default=False, help=argparse.SUPPRESS)
...
parser.add_argument("--max_pos_delta", type=float, default=0.012, help="Max processed position delta outside insert.")
parser.add_argument("--max_rot_delta", type=float, default=0.14, help="Max processed rotation delta outside insert.")
...
def main() -> None:
    ...
    env_cfg = parse_env_cfg(
        ...
        use_fabric=args_cli.enable_fabric and not args_cli.disable_fabric,
    )
    ...
    elif hasattr(env_cfg.scene, args_cli.contact_sensor_name):
        getattr(env_cfg.scene, args_cli.contact_sensor_name).prim_path = args_cli.contact_prim_path
